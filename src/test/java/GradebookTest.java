...
public class GradebookTest {
    ...
    Stream<DynamicTest> dynamicTestsForAverageForAllSubjects() {
        ...
        tests.add(DynamicTest.dynamicTest("Add grade 5.0 to Math", () -> {
            gradebook.addGrade("Math", 5.0);
            assertEquals(5.0, gradebook.calcAvgForAllSubjects(), 0.001);
        }));

        tests.add(DynamicTest.dynamicTest("Add grade 4.0 to Chemistry", () -> {
        ...
        tests.add(DynamicTest.dynamicTest("Add grade 3.0 to Biology", () -> {
            gradebook.addGrade("Biology", 3.0);
            assertEquals(4.25, gradebook.calcAvgForAllSubjects(), 0.001);
        }));

        tests.add(DynamicTest.dynamicTest("Add grade 4.0 to Physics", () -> {
